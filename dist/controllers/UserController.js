...
var _require = require("../../dbsetup"),
  getUsersData = _require.getUsersData,
  deleteAcc = _require.deleteAcc;
var UserController = /*#__PURE__*/function () {
  ...
  return _createClass(UserController, [{
    ...
    function show(req, res, next) {
      Promise.all([getUsersData()]).then(function (_ref) {
    ...
    value: function _delete(req, res, next) {
      ...
      Promise.all([deleteAcc(user_id)]).then(function (_ref3) {
